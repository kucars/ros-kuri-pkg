...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/rui/catkin_ws/src/ros-kuri-pkg/navigation)
  set(navigation_DEVEL_PREFIX /home/rui/catkin_ws/src/ros-kuri-pkg/qtcreator-build/devel)
  ...
  set(navigation_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/rui/catkin_ws/src/ros-kuri-pkg/qtcreator-build/devel/include" STREQUAL "")
  set(navigation_INCLUDE_DIRS "")
  set(_include_dirs "/home/rui/catkin_ws/src/ros-kuri-pkg/qtcreator-build/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Rui Pimentel de Figueiredo and Reem Ashour <rui.defigueiredo@kustar.ac.ae>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rui/catkin_ws/src/ros-kuri-pkg/navigation/${idir}'.  Ask the maintainer 'Rui Pimentel de Figueiredo and Reem Ashour <rui.defigueiredo@kustar.ac.ae>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rui/catkin_ws/src/ros-kuri-pkg/qtcreator-build/devel/lib;/home/rui/catkin_ws/devel/lib;/home/rui/repositories/ros/ros_catkin/catkin_ws/devel/lib;/opt/ros/hydro/lib)
