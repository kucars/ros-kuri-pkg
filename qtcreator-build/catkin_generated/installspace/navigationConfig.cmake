...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Rui Pimentel de Figueiredo and Reem Ashour <rui.defigueiredo@kustar.ac.ae>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/home/rui/catkin_ws/devel/lib;/home/rui/repositories/ros/ros_catkin/catkin_ws/devel/lib;/opt/ros/hydro/lib)
