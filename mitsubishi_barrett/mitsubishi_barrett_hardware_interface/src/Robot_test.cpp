...
//    MitsubishiArmInterface mitsubishi_robot;
//    Mitsu barrett_robot(canbus_number, forcetorque, tactile,  calibration_filename, ft_pub_freq, tactile_pub_freq);

    controller_manager::ControllerManager cm_mitsubishi(&mitsubishi_robot, n);
    controller_manager::ControllerManager cm_barrett(&barrett_robot, n);
    ...
    {
        ros::Duration period;
        mitsubishi_robot.readHW();
        barrett_robot.readHW();
        ros::Time now=ros::Time::now();
        period=now-previous;
        //std::cout << "period:"<<period<<std::endl;
        //mitsubishi_robot.update(now, period);
        mitsubishi_robot.writeHW();
        barrett_robot.writeHW();
